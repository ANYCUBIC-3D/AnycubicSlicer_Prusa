...
namespace Slic3r {
  ...
  class Print;
    ...
    public:
        ...
        void ac_process_file(bool isACLoad,std::function<void(double, double,std::string)> setPrintStatistics_callback,const std::string &filename, std::function<void()> cancel_callback = nullptr);

        // Streaming interface, for processing G-codes just generated by Anycubic Slicer in a pipelined fashion.
