...
namespace ImGui
{
    ...
    IMGUI_API bool          ACBeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags = 0, float arrowWidth = 0);
    ...
    IMGUI_API bool          ListBox(const int&  rounding,
                                    const char *label,
                                    int *       current_item,
