...
static const char* URL_CHANGELOG = "https://files.xxxxxxx.com/?latest=slicer-stable&lng=%1%";
static const char* URL_DOWNLOAD = "https://www.xxxxxxx.com/slicerweb&lng=%1%";
static const char* URL_DEV = "https://github.com/xxxxxxx/PrusaSlicer/releases/tag/version_%1%";

static const std::string CONFIG_UPDATE_WIKI_URL("https://github.com/xxxxxxx/PrusaSlicer/wiki/Slic3r-PE-1.40-configuration-update");
											 ...
											 _L("Configuration update is available"), wxICON_ERROR)
{
	...
	add_button(wxID_OK, true, force_before_wizard ? _L("Install") : _L("OK"));
