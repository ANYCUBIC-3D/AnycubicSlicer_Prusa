...
public:
    ...
    PresetComboBox(wxWindow *parent, Preset::Type preset_type,bool drawLeftIco,bool drawRightIco, const wxSize &size = wxDefaultSize, PresetBundle *preset_bundle = nullptr);
    ~PresetComboBox();
