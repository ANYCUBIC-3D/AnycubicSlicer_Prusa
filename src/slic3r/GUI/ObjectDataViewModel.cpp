...
static constexpr char LayerRootIcon[]   = "ACEmpty";
static constexpr char LayerIcon[]       = "ACEmpty";
static constexpr char WarningIcon[]     = "ACEmpty";
static constexpr char WarningManifoldIcon[] = "ACEmpty";
static constexpr char LockIcon[]        = "ACEmpty";
...
//           info_item Type                         info_item Name              info_item BitmapName
            { InfoItemType::CustomSupports,      {L("Paint-on supports"),       "ACEmpty" },     },
            { InfoItemType::CustomSeam,          {L("Paint-on seam"),           "ACEmpty" },             },
            { InfoItemType::CutConnectors,       {L("Cut connectors"),          "ACEmpty" },    },
            { InfoItemType::MmuSegmentation,     {L("Multimaterial painting"),  "ACEmpty"},  },
            { InfoItemType::Sinking,             {L("Sinking"),                 "ACEmpty"},            },
            { InfoItemType::VariableLayerHeight, {L("Variable layer height"),   "ACEmpty"},             },
};
...
{
    m_action_icon_name = m_type & itObject              ? "ACEmpty" : 
                         m_type & (itVolume | itLayer)  ? "ACEmpty" : /*m_type & itInstance*/ "ACEmpty";
...
void ObjectDataViewModelNode::set_printable_icon(PrintIndicator printable)
{
    ...
    m_printable_icon = m_printable == piUndef ? m_empty_bmp :
                       *get_bmp_bundle(m_printable == piPrintable ? "ACEmpty" : "ACEmpty");
}
...
void ObjectDataViewModelNode::sys_color_changed()
{
    ...
    if (m_printable != piUndef)
        m_printable_icon = *get_bmp_bundle(m_printable == piPrintable ? "ACEmpty" : "ACEmpty");
