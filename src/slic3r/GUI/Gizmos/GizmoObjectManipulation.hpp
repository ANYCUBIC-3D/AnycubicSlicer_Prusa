...
public:
    ...
    void do_render_ac_layout_window(ImGuiWrapper *imgui_wrapper, std::string window_name, float x, float y, float bottom_limit);
...
private:
    ...
    void move_position_value_to_center();
