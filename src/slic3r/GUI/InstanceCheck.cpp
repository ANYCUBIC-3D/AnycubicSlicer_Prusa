...
namespace instance_check_internal
{
	...
	{
		//checks for other instances of Anycubic Slicer, if found brings it to front and return false to stop enumeration and quit this instance
	...
	static bool  send_message(const std::string &message_text, const std::string &version)
	{
		...
		if ( !checker->IsAnotherRunning() ) */
		{
			...
			//std::string		interface_name = "com.anycubic.anycubicslicer.InstanceCheck";
			std::string		interface_name = "com.anycubic.anycubicslicer.InstanceCheck.Object" + version;
			std::string   	method_name = "AnotherInstance";
			//std::string		object_name = "/com/anycubic/anycubicslicer/InstanceCheck";
			std::string		object_name = "/com/anycubic/anycubicslicer/InstanceCheck/Object" + version;
...
OtherInstanceMessageHandler::~OtherInstanceMessageHandler() 
{ 
	assert(!m_initialized);
}
...
#ifdef _WIN32
		else if (it->rfind("anycubicslicer://open/?file=", 0) == 0)
#else
	    else if (it->rfind("anycubicslicer://open?file=", 0) == 0)
#endif
...
namespace MessageHandlerDBusInternal
{
	...
	static void respond_to_introspect(DBusConnection *connection, DBusMessage *request) 
	{
	    ...
	    const char  *introspection_data =
	        ...
	        "     </method>"
	        "   </interface>"
	        "   <interface name=\"com.anycubic.anycubicslicer.InstanceCheck\">"
	...
	//method AnotherInstance receives message from another Anycubic Slicer instance 
	...
	static DBusHandlerResult handle_dbus_object_message(DBusConnection *connection, DBusMessage *message, void *user_data)
	{
	    ...
	    std::string our_interface  = "com.anycubic.anycubicslicer.InstanceCheck.Object" + wxGetApp().get_instance_hash_string();
...
void OtherInstanceMessageHandler::listen()
{
	...
	std::string			 interface_name = "com.anycubic.anycubicslicer.InstanceCheck.Object" + instance_hash;
    std::string			 object_name 	= "/com/anycubic/anycubicslicer/InstanceCheck/Object" + instance_hash;
