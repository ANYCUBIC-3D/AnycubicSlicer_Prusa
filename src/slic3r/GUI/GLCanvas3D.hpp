...
wxDECLARE_EVENT(EVT_GLCANVAS_SHOWTAB, SimpleEvent);
wxDECLARE_EVENT(EVT_GLCANVAS_CLOSEPATEST, Event<std::vector<std::string>>);
...
private:
    ...
    enum ICON_TEXTURE_ID {
        ICON_PANEL_MACHINE,
        ICON_PANEL_FILAMENT,
        ICON_PANEL_SETTING,
        ICON_PANEL_SET_QUALITY,
        ICON_PANEL_SET_NORMAL,
        ICON_PANEL_SET_FAST,
        ICON_PANEL_SET_CUSTOM,
        ICON_PANEL_INFILL,
        ICON_PANEL_OBJLIST,
        ICON_PANEL_OBJ,
        IC_COMBO_UP,
    ...
    void* get_icon_texture_id(ICON_TEXTURE_ID icon) const {
...
public:
    ...
    void clearKeyResidual();
    bool init();
    void post_event(wxEvent &&event);
    void sendChangeViewEvent(int index = 1);
    ...
    std::shared_ptr<SceneRaycasterItem> add_raycaster_for_picking(SceneRaycaster::EType type, int id, const MeshRaycaster& raycaster,
        const Transform3d& trafo = Transform3d::Identity(), bool use_back_faces = true) {
    ...
    void setOpenNewProjectPar(bool index) { m_isOpenNewProject = index; }


private:
    bool m_isOpenNewProject{false};
    ...
    void _render_return_toolbar(float &_scaleIndex);
    void _render_selection_info();
    //void _render_panel_machine() ;
    //void _render_panel_print_set() ;
    //void _render_panel_objectlist() ;

    void _render_panel_machine(float &_scaleIndex);
    void _render_panel_print_set(float &_scaleIndex);
    void _render_panel_objectlist(float &_scaleIndex);

    void init_preset_combobox(Preset::Type type, const PresetCollection& collection, std::map<std::string, const Preset*>& itemsMap, std::string& select_preset_name, int extruderIndex = 0) const;
