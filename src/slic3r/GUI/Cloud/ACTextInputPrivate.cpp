...
BEGIN_EVENT_TABLE(ACTextInputPrivate, ACStaticBox)

EVT_PAINT(ACTextInputPrivate::paintEvent)
...
ACTextInputPrivate::ACTextInputPrivate()
    : label_color(
...
ACTextInputPrivate::ACTextInputPrivate(wxWindow *     parent,
                     wxString       text,
                     wxString       label,
                     wxString       iconName,
                     wxSize         iconSize,
...
void ACTextInputPrivate::Create(wxWindow* parent,
	wxString       text,
	wxString       label,
	wxString       iconName,
	wxSize         iconSize,
...
void ACTextInputPrivate::SetCornerRadius(double radius)
{
	this->radius = radius;
	Refresh();
}

void ACTextInputPrivate::SetLabel(const wxString& label)
{
	wxWindow::SetLabel(label);
...
void ACTextInputPrivate::SetIcon(const wxString& iconName, wxSize iconSize)
{
...
void ACTextInputPrivate::SetLabelColor(ACStateColor const& color)
{
	label_color = color;
	state_handler.update_binds();
}

void ACTextInputPrivate::SetTextColor(ACStateColor const& color)
{
	text_color = color;
	state_handler.update_binds();
}

void ACTextInputPrivate::Rescale()
{
...
bool ACTextInputPrivate::Enable(bool enable)
{
...
void ACTextInputPrivate::SetMinSize(const wxSize& size)
{
	wxSize size2 = size;
	if (size2.y < 0)
	{
...
void ACTextInputPrivate::DoSetSize(int x, int y, int width, int height, int sizeFlags)
{
...
void ACTextInputPrivate::DoSetToolTipText(wxString const& tip)
{
	wxWindow::DoSetToolTipText(tip);
	text_ctrl->SetToolTip(tip);
}

void ACTextInputPrivate::paintEvent(wxPaintEvent& evt)
{
 ...
 */
void ACTextInputPrivate::render(wxPaintDC& dc)
{
...
void ACTextInputPrivate::messureSize()
{
