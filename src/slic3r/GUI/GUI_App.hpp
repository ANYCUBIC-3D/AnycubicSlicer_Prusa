...
public:
    ...
    bool            switch_language(const wxLanguageInfo *new_language_info);
    bool            switch_language();
    bool            load_language(wxString language, bool initial);
    bool            select_language(const wxLanguageInfo *new_language_info);
    ...
    // URL download - Anycubic Slicer gets system call to open prusaslicer:// URL which should contain address of download
