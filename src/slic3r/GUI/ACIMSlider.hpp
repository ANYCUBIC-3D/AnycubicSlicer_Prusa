#ifndef slic3r_GUI_ACIMSlider_hpp_
#define slic3r_GUI_ACIMSlider_hpp_

#include "libslic3r/CustomGCode.hpp"
#include "wxExtensions.hpp"
#include "ACIMSlider_Utils.hpp"
...
{
public:
    ACIMSlider(int lowerValue, int higherValue, int minValue, int maxValue, long style = wxSL_VERTICAL);
