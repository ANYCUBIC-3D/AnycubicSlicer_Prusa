...
public:
	...
	//finds paths to models in message(= command line arguments, first should be Anycubic Slicer executable)
	...
	//						mac - anybody who posts notification with name:@"OtherAnycubic SlicerTerminating"
