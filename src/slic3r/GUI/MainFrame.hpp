...
class MainFrame : public DPIFrame
{
    ...
    enum MenuItems {   //   FFF                  SLA
        miExport = 2,  // Export G-code        Export
        miSend = 3,        // Send G-code          Send to print
        miMaterialTab = 0, // Filament Settings    Material Settings
        miPrinterTab = 1,  // Different bitmap for Printer Settings
    };
...
public:
    ...
    void        add_created_tab(Tab *panel, const std::string &bmp_name, const std::string &click_bmp_name);
